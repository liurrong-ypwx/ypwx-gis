...
var shouldUseSourceMap = process.env.GENERATE_SOURCEMAP !== 'false'; // Some apps do not need the benefits of saving a web request, so not inlining the chunk
...
var sassModuleRegex = /\.module\.(scss|sass)$/; // 添加less支持

var lessRegex = /\.less$/;
var lessModuleRegex = /\.module\.less$/; // This is the production and development configuration.
...
module.exports = function (webpackEnv) {
  ...
  var env = getClientEnvironment(paths.publicUrlOrPath.slice(0, -1)); // common function to get style loaders
  ...
  var getStyleLoaders = function getStyleLoaders(cssOptions, preProcessor) {
    ...
    if (preProcessor) {
      // ======================================================================
      var loader = require.resolve(preProcessor);
      ...
      if (preProcessor === "less-loader") {
        loader = {
          ...
          options: {
            ...
            // --------改变antd的初始颜色---------------------------------------
            modifyVars: {// 很遗憾，这个一行不仅不生效，还会报错
              // 'hack': `true; @import "../src/assets/less/ant-theme.less";`, 
